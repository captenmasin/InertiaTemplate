...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/services</a> eslint.ts</h1>
        <div class='clearfix'>
...
function getTrailingCommentsFromSameLine(sourceCode: SourceCode, node: Node) {
  return sourceCode
    ...
    .filter(comment =&gt; comment.loc<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tart.line === node.loc<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tart.line);
}
&nbsp;
...
&nbsp;
    const leadingComments = sourceCode
      ...
      .filter(comment =&gt; comment.loc<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tart.line !== 1);
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (pipe) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed May 05 2021 23:59:19 GMT+0300 (Восточная Европа, летнее время)
            </div>
        </div>
